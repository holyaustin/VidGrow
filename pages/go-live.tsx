...
export default function App() {
  ...
  return (
    <main className="container pb-12 h-screen m-auto pt-12 lg:pt-12">
      ...
      />
      <footer className="font-extrabold fixed bottom-0 bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-sky-700 left-0 w-full h-20 flex items-center justify-center">
        Made with the&nbsp;
